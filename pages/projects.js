...
export default function Projects() {
  ...
  return (
    <ContainerBlock>
      ...
      <div className="grid grid-cols-3 gap-4 mt-10 ml-7 mb-3 bg-classique sm:ml-12  max-sm:grid-cols-1 min-[320px]:mr-10 mb-20">
        {loading == false ? (
          <>
            {data.map((resultat, index) => (
              <Link key={index} href={`/project/${resultat.id}`}>
                <div  className="ml-7 mt-4 sm:ml-12 ">
          ...
          <div className="items-center ml-40 px-40">
